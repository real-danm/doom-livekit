        ...
        .then((data) => {
            choosePet((petname) => {
                deathMatchOr(() => {
                    ...
                    t += `<h1><a class="perma h" data-clipboard-text="${web}/?room=${room}">${web}/${room.slice(0, 8)}...${room.slice(-8)}</a></h1>`;
                    ...
                    t += '<div class="vspace">';
                    t += `<a id="clip" class="btn tertiary perma" data-clipboard-text="${web}/?room=${room}" data-room="${room}">Copy Permalink</a>`;
